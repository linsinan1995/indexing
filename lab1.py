...
if __name__ == "__main__":
    img = imageCls(["data/MarsBar1.jpg", "data/MarsBar2.jpg"])
    img.display(0)
    img.sift_kp_detect(draw=True)
    img.match()
    data_dir = "data/VOC2007/JPEGImages/"
    # pick 50 images in this dir
    # _, _ data_paths= os.walk(data_dir)
    data_paths = [data_dir+image  for _, _, images in os.walk(data_dir) for i, image in enumerate(images) if i < 50]
